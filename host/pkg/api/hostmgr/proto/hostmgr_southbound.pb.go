...
const file_hostmgr_proto_hostmgr_southbound_proto_rawDesc = "" +
	...
	"\tbios_info\x18\x04 \x01(\v2\".hostmgr_southbound_proto.BiosInfoR\bbiosInfo\"\xc5\x02\n" +
	"\bBiosInfo\x12%\n" +
	"\aversion\x18\x01 \x01(\tB\v\xfaB\br\x06\x18\x80\x01\xd0\x01\x01R\aversion\x12\xed\x01\n" +
	"\frelease_date\x18\x02 \x01(\tB\xc9\x01\xfaB\xc5\x01r\xc2\x01\x18\x80\x012\xb9\x01`^((\\d{4})/(0[1-9]|1[0-2])/(0[1-9]|[12]\\d|3[01])|(0[1-9]|1[0-2])/(0[1-9]|[12]\\d|3[01])/\\d{4}|(\\d{4})-(0[1-9]|1[0-2])-(0[1-9]|[12]\\d|3[01])|(0[1-9]|1[0-2])-(0[1-9]|[12]\\d|3[01])-\\d{4})$`\xd0\x01\x01R\vreleaseDate\x12\"\n" +
