...
const file_hostmgr_proto_hostmgr_southbound_proto_rawDesc = "" +
	"\n" +
	"&hostmgr/proto/hostmgr_southbound.proto\x12\x18hostmgr_southbound_proto\x1a\x17validate/validate.proto\"\xec\x02\n" +
	"\n" +
	"HostStatus\x12Q\n" +
	"\vhost_status\x18\x01 \x01(\x0e20.hostmgr_southbound_proto.HostStatus.Host_statusR\n" +
	"hostStatus\x12\x18\n" +
	"\adetails\x18\x02 \x01(\tR\adetails\x122\n" +
	"\x15human_readable_status\x18\x03 \x01(\tR\x13humanReadableStatus\"\xbc\x01\n" +
	"\vHost_status\x12\x0f\n" +
	"\vUNSPECIFIED\x10\x00\x12\x0f\n" +
	"\vREGISTERING\x10\x01\x12\v\n" +
	"\aBOOTING\x10\x02\x12\x0e\n" +
	"\n" +
	"BOOTFAILED\x10\x03\x12\x10\n" +
	"\fPROVISIONING\x10\x04\x12\x0f\n" +
	"\vPROVISIONED\x10\x05\x12\x13\n" +
	"\x0fPROVISIONFAILED\x10\x06\x12\v\n" +
	"\aRUNNING\x10\a\x12\f\n" +
	"\bUPDATING\x10\b\x12\x10\n" +
	"\fUPDATEFAILED\x10\t\x12\t\n" +
	"\x05ERROR\x10\n" +
	"\"\xd0\x01\n" +
	"\x0eHostStatusResp\x12U\n" +
	"\vhost_action\x18\x01 \x01(\x0e24.hostmgr_southbound_proto.HostStatusResp.Host_actionR\n" +
	"hostAction\x12\x18\n" +
	"\adetails\x18\x02 \x01(\tR\adetails\"M\n" +
	"\vHost_action\x12\b\n" +
	"\x04NONE\x10\x00\x12\f\n" +
	"\bSHUTDOWN\x10\x01\x12\v\n" +
	"\aRESTART\x10\x02\x12\f\n" +
	"\bUPDATING\x10\x03\x12\v\n" +
	"\aRUNNING\x10\x04\"2\n" +
	"\bMetadata\x12\x10\n" +
	...
	"\n" +
	"SystemInfo\x129\n" +
	"\ahw_info\x18\x01 \x01(\v2 .hostmgr_southbound_proto.HWInfoR\x06hwInfo\x129\n" +
	"\aos_info\x18\x02 \x01(\v2 .hostmgr_southbound_proto.OsInfoR\x06osInfo\x12@\n" +
	"\vbm_ctl_info\x18\x03 \x01(\v2 .hostmgr_southbound_proto.BmInfoR\tbmCtlInfo\x12?\n" +
	"\tbios_info\x18\x04 \x01(\v2\".hostmgr_southbound_proto.BiosInfoR\bbiosInfo\x12>\n" +
	"\akc_info\x18\x05 \x01(\v2%.hostmgr_southbound_proto.ClusterInfoR\x06kcInfo\"-\n" +
	"\vClusterInfo\x12\x1e\n" +
	"\n" +
	"kubeconfig\x18\x01 \x01(\tR\n" +
	"kubeconfig\"\xc3\x02\n" +
	"\bBiosInfo\x12%\n" +
	"\aversion\x18\x01 \x01(\tB\v\xfaB\br\x06\x18\x80\x01\xd0\x01\x01R\aversion\x12\xeb\x01\n" +
	"\frelease_date\x18\x02 \x01(\tB\xc7\x01\xfaB\xc3\x01r\xc0\x01\x18\x80\x012\xb7\x01^((\\d{4})/(0[1-9]|1[0-2])/(0[1-9]|[12]\\d|3[01])|(0[1-9]|1[0-2])/(0[1-9]|[12]\\d|3[01])/\\d{4}|(\\d{4})-(0[1-9]|1[0-2])-(0[1-9]|[12]\\d|3[01])|(0[1-9]|1[0-2])-(0[1-9]|[12]\\d|3[01])-\\d{4})$\xd0\x01\x01R\vreleaseDate\x12\"\n" +
	"\x06vendor\x18\x03 \x01(\tB\n" +
	"\xfaB\ar\x05\x18(\xd0\x01\x01R\x06vendor\"\x83\x01\n" +
	"\x06OsInfo\x12:\n" +
	"\x06kernel\x18\x01 \x01(\v2\".hostmgr_southbound_proto.OsKernelR\x06kernel\x12=\n" +
	"\arelease\x18\x02 \x01(\v2#.hostmgr_southbound_proto.OsReleaseR\arelease\"0\n" +
	"\x06Config\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\"h\n" +
	"\bOsKernel\x12\"\n" +
	"\aversion\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\aversion\x128\n" +
	"\x06config\x18\x02 \x03(\v2 .hostmgr_southbound_proto.ConfigR\x06config\"\x89\x01\n" +
	"\tOsRelease\x12\x18\n" +
	"\x02id\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\x02id\x12\"\n" +
	"\aversion\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\aversion\x12>\n" +
	"\bmetadata\x18\x03 \x03(\v2\".hostmgr_southbound_proto.MetadataR\bmetadata\"_\n" +
	"\aStorage\x128\n" +
	"\x04disk\x18\x01 \x03(\v2$.hostmgr_southbound_proto.SystemDiskR\x04disk\x12\x1a\n" +
	"\bfeatures\x18\x02 \x03(\tR\bfeatures\"\xca\x04\n" +
	"\x06HWInfo\x12'\n" +
	"\n" +
	"serial_num\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\tserialNum\x12+\n" +
	"\fproduct_name\x18\t \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\vproductName\x125\n" +
	"\x03cpu\x18\x02 \x01(\v2#.hostmgr_southbound_proto.SystemCPUR\x03cpu\x12N\n" +
	"\x0egpu_deprecated\x18\x03 \x01(\v2#.hostmgr_southbound_proto.SystemGPUB\x02\x18\x01R\rgpuDeprecated\x12>\n" +
	"\x06memory\x18\x04 \x01(\v2&.hostmgr_southbound_proto.SystemMemoryR\x06memory\x12;\n" +
	"\astorage\x18\x05 \x01(\v2!.hostmgr_southbound_proto.StorageR\astorage\x12A\n" +
	"\anetwork\x18\x06 \x03(\v2'.hostmgr_southbound_proto.SystemNetworkR\anetwork\x125\n" +
	"\x03pci\x18\a \x03(\v2#.hostmgr_southbound_proto.SystemPCIR\x03pci\x125\n" +
	"\x03usb\x18\b \x03(\v2#.hostmgr_southbound_proto.SystemUSBR\x03usb\x125\n" +
	"\x03gpu\x18\n" +
	" \x03(\v2#.hostmgr_southbound_proto.SystemGPUR\x03gpu\"\xb6\x02\n" +
	"\tSystemCPU\x12\x1c\n" +
	"\x04arch\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\x04arch\x12 \n" +
	"\x06vendor\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\x06vendor\x12\x1e\n" +
	"\x05model\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\x05model\x12!\n" +
	"\asockets\x18\x04 \x01(\rB\a\xfaB\x04*\x02 \x00R\asockets\x12\x1d\n" +
	"\x05cores\x18\x05 \x01(\rB\a\xfaB\x04*\x02 \x00R\x05cores\x12!\n" +
	"\athreads\x18\x06 \x01(\rB\a\xfaB\x04*\x02 \x00R\athreads\x12\x1a\n" +
	"\bfeatures\x18\a \x03(\tR\bfeatures\x12H\n" +
	"\fcpu_topology\x18\b \x01(\v2%.hostmgr_southbound_proto.CPUTopologyR\vcpuTopology\"+\n" +
	"\fSystemMemory\x12\x1b\n" +
	"\x04size\x18\x01 \x01(\x04B\a\xfaB\x042\x02 \x00R\x04size\"\xcf\x01\n" +
	"\n" +
	"SystemDisk\x12-\n" +
	"\rserial_number\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\fserialNumber\x12\x1e\n" +
	"\x04name\x18\x02 \x01(\tB\n" +
	"\xfaB\ar\x05\x10\x01\x18\x80\x01R\x04name\x12 \n" +
	"\x06vendor\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\x06vendor\x12\x1e\n" +
	"\x05model\x18\x04 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\x05model\x12\x12\n" +
	"\x04size\x18\x05 \x01(\x04R\x04size\x12\x1c\n" +
	"\x04wwid\x18\x06 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\x04wwid\"\xe2\x01\n" +
	"\tSystemGPU\x12$\n" +
	"\x06pci_id\x18\x01 \x01(\tB\r\xfaB\n" +
	"r\b\x10\x01\x18\x80\x01\xd0\x01\x01R\x05pciId\x12\"\n" +
	"\aproduct\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\aproduct\x12 \n" +
	"\x06vendor\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\x06vendor\x12!\n" +
	"\x04name\x18\x04 \x01(\tB\r\xfaB\n" +
	"r\b\x10\x01\x18\x80\x01\xd0\x01\x01R\x04name\x12*\n" +
	"\vdescription\x18\x05 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\vdescription\x12\x1a\n" +
	"\bfeatures\x18\x06 \x03(\tR\bfeatures\"\x96\x06\n" +
	"\rSystemNetwork\x12\x1e\n" +
	"\x04name\x18\x01 \x01(\tB\n" +
	"\xfaB\ar\x05\x10\x01\x18\x80\x01R\x04name\x12\x1f\n" +
	"\x06pci_id\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\x05pciId\x12\x1a\n" +
	"\x03mac\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\x03mac\x12\x1d\n" +
	"\n" +
	"link_state\x18\x04 \x01(\bR\tlinkState\x12#\n" +
	"\rcurrent_speed\x18\x05 \x01(\x04R\fcurrentSpeed\x12/\n" +
	"\x0ecurrent_duplex\x18\x06 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\rcurrentDuplex\x12.\n" +
	"\x13supported_link_mode\x18\a \x03(\tR\x11supportedLinkMode\x122\n" +
	"\x15advertising_link_mode\x18\b \x03(\tR\x13advertisingLinkMode\x12\x1a\n" +
	"\bfeatures\x18\t \x03(\tR\bfeatures\x12\"\n" +
	"\fsriovenabled\x18\n" +
	" \x01(\bR\fsriovenabled\x12 \n" +
	"\vsriovnumvfs\x18\v \x01(\rR\vsriovnumvfs\x12&\n" +
	"\x0fsriov_vfs_total\x18\x14 \x01(\rR\rsriovVfsTotal\x12%\n" +
	"\tpeer_name\x18\f \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\bpeerName\x123\n" +
	"\x10peer_description\x18\r \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\x0fpeerDescription\x12#\n" +
	"\bpeer_mac\x18\x0e \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\apeerMac\x12*\n" +
	"\fpeer_mgmt_ip\x18\x0f \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\n" +
	"peerMgmtIp\x12%\n" +
	"\tpeer_port\x18\x10 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\bpeerPort\x12F\n" +
	"\fip_addresses\x18\x11 \x03(\v2#.hostmgr_southbound_proto.IPAddressR\vipAddresses\x12\x10\n" +
	"\x03mtu\x18\x12 \x01(\rR\x03mtu\x12\x17\n" +
	"\abmc_net\x18\x13 \x01(\bR\x06bmcNet\"S\n" +
	"\vCPUTopology\x12D\n" +
	"\asockets\x18\x01 \x03(\v2 .hostmgr_southbound_proto.SocketB\b\xfaB\x05\x92\x01\x02\b\x01R\asockets\"u\n" +
	"\x06Socket\x12\x1b\n" +
	"\tsocket_id\x18\x01 \x01(\rR\bsocketId\x12N\n" +
	"\vcore_groups\x18\x02 \x03(\v2#.hostmgr_southbound_proto.CoreGroupB\b\xfaB\x05\x92\x01\x02\b\x01R\n" +
	"coreGroups\"Q\n" +
	"\tCoreGroup\x12\x1b\n" +
	"\tcore_type\x18\x01 \x01(\tR\bcoreType\x12'\n" +
	"\tcore_list\x18\x03 \x03(\rB\n" +
	"\xfaB\a\x92\x01\x04\b\x01\x18\x01R\bcoreList\"\xb6\x01\n" +
	"\tIPAddress\x12&\n" +
	"\n" +
	"ip_address\x18\x01 \x01(\tB\a\xfaB\x04r\x02p\x01R\tipAddress\x12:\n" +
	"\x13network_prefix_bits\x18\x02 \x01(\x05B\n" +
	"\xfaB\a\x1a\x05\x10\x80\x01(\x01R\x11networkPrefixBits\x12E\n" +
	"\vconfig_mode\x18\x04 \x01(\x0e2$.hostmgr_southbound_proto.ConfigModeR\n" +
	"configMode\"2\n" +
	"\tSystemPCI\x12%\n" +
	"\tdev_class\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\bdevClass\",\n" +
	"\n" +
	"Interfaces\x12\x1e\n" +
	"\x05class\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\x05class\"\xb3\x02\n" +
	"\tSystemUSB\x12\x1e\n" +
	"\x05class\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\x05class\x12$\n" +
	"\bidvendor\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\bidvendor\x12&\n" +
	"\tidproduct\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\tidproduct\x12\x10\n" +
	"\x03bus\x18\x04 \x01(\rR\x03bus\x12\x12\n" +
	"\x04addr\x18\x05 \x01(\rR\x04addr\x12*\n" +
	"\vdescription\x18\x06 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\vdescription\x12 \n" +
	"\x06serial\x18\a \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\x06serial\x12D\n" +
	"\n" +
	"interfaces\x18\b \x03(\v2$.hostmgr_southbound_proto.InterfacesR\n" +
	"interfaces\"\xd1\x01\n" +
	"\x06BmInfo\x12A\n" +
	"\abm_type\x18\x01 \x01(\x0e2(.hostmgr_southbound_proto.BmInfo.Bm_typeR\x06bmType\x12<\n" +
	"\bbmc_info\x18\x02 \x01(\v2!.hostmgr_southbound_proto.BmcInfoR\abmcInfo\"F\n" +
	"\aBm_type\x12\b\n" +
	"\x04IPMI\x10\x00\x12\v\n" +
	"\aREDFISH\x10\x01\x12\a\n" +
	"\x03PDU\x10\x02\x12\b\n" +
	"\x04VPRO\x10\x03\x12\a\n" +
	"\x03FDO\x10\x04\x12\b\n" +
	"\x04NONE\x10\x05\"~\n" +
	"\aBmcInfo\x12\x1d\n" +
	"\x05bm_ip\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\x04bmIp\x12)\n" +
	"\vbm_username\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\n" +
	"bmUsername\x12)\n" +
	"\vbm_password\x18\x03 \x01(\tB\b\xfaB\x05r\x03\x18\x80\x01R\n" +
	"bmPassword\"\x9f\x01\n" +
	"!UpdateHostStatusByHostGuidRequest\x12)\n" +
	"\thost_guid\x18\x01 \x01(\tB\f\xfaB\tr\a\x10\x01($\xb0\x01\x01R\bhostGuid\x12O\n" +
	"\vhost_status\x18\x02 \x01(\v2$.hostmgr_southbound_proto.HostStatusB\b\xfaB\x05\x8a\x01\x02\x10\x01R\n" +
	"hostStatus\"\x9f\x01\n" +
	"!UpdateHostSystemInfoByGUIDRequest\x12)\n" +
	"\thost_guid\x18\x01 \x01(\tB\f\xfaB\tr\a\x10\x01($\xb0\x01\x01R\bhostGuid\x12O\n" +
	"\vsystem_info\x18\x02 \x01(\v2$.hostmgr_southbound_proto.SystemInfoB\b\xfaB\x05\x8a\x01\x02\x10\x01R\n" +
	"systemInfo\"$\n" +
	"\"UpdateHostSystemInfoByGUIDResponse\"\xae\x02\n" +
	"*UpdateInstanceStateStatusByHostGUIDRequest\x12'\n" +
	"\thost_guid\x18\x01 \x01(\tB\n" +
	"\xfaB\ar\x05($\xb0\x01\x01R\bhostGuid\x12Q\n" +
	"\x0finstance_status\x18\x02 \x01(\x0e2(.hostmgr_southbound_proto.InstanceStatusR\x0einstanceStatus\x12N\n" +
	"\x0einstance_state\x18\x03 \x01(\x0e2'.hostmgr_southbound_proto.InstanceStateR\rinstanceState\x124\n" +
	"\x16provider_status_detail\x18\x04 \x01(\tR\x14providerStatusDetail\"-\n" +
	"+UpdateInstanceStateStatusByHostGUIDResponse*Z\n" +
	"\n" +
	"ConfigMode\x12\x1b\n" +
	"\x17CONFIG_MODE_UNSPECIFIED\x10\x00\x12\x16\n" +
	"\x12CONFIG_MODE_STATIC\x10\x01\x12\x17\n" +
	"\x13CONFIG_MODE_DYNAMIC\x10\x02*\xa1\x01\n" +
	"\rInstanceState\x12\x1e\n" +
	"\x1aINSTANCE_STATE_UNSPECIFIED\x10\x00\x12\x1c\n" +
	"\x18INSTANCE_STATE_INSTALLED\x10\x02\x12\x1a\n" +
	"\x16INSTANCE_STATE_RUNNING\x10\x03\x12\x1a\n" +
	"\x16INSTANCE_STATE_STOPPED\x10\x04\x12\x1a\n" +
	"\x16INSTANCE_STATE_DELETED\x10\x05*\xf3\x02\n" +
	"\x0eInstanceStatus\x12\x1f\n" +
	"\x1bINSTANCE_STATUS_UNSPECIFIED\x10\x00\x12\x1b\n" +
	"\x17INSTANCE_STATUS_BOOTING\x10\x01\x12\x1f\n" +
	"\x1bINSTANCE_STATUS_BOOT_FAILED\x10\x02\x12 \n" +
	"\x1cINSTANCE_STATUS_PROVISIONING\x10\x03\x12\x1f\n" +
	"\x1bINSTANCE_STATUS_PROVISIONED\x10\x04\x12$\n" +
	" INSTANCE_STATUS_PROVISION_FAILED\x10\x05\x12\x1b\n" +
	"\x17INSTANCE_STATUS_RUNNING\x10\x06\x12\x19\n" +
	"\x15INSTANCE_STATUS_ERROR\x10\a\x12\x1c\n" +
	"\x18INSTANCE_STATUS_UPDATING\x10\t\x12!\n" +
	"\x1dINSTANCE_STATUS_UPDATE_FAILED\x10\n" +
	"\x12 \n" +
	"\x1cINSTANCE_STATUS_INITIALIZING\x10\v2\xe4\x03\n" +
	"\aHostmgr\x12\x85\x01\n" +
	"\x1aUpdateHostStatusByHostGuid\x12;.hostmgr_southbound_proto.UpdateHostStatusByHostGuidRequest\x1a(.hostmgr_southbound_proto.HostStatusResp\"\x00\x12\xb4\x01\n" +
	"#UpdateInstanceStateStatusByHostGUID\x12D.hostmgr_southbound_proto.UpdateInstanceStateStatusByHostGUIDRequest\x1aE.hostmgr_southbound_proto.UpdateInstanceStateStatusByHostGUIDResponse\"\x00\x12\x99\x01\n" +
	"\x1aUpdateHostSystemInfoByGUID\x12;.hostmgr_southbound_proto.UpdateHostSystemInfoByGUIDRequest\x1a<.hostmgr_southbound_proto.UpdateHostSystemInfoByGUIDResponse\"\x00B\x16Z\x14.;hostmgr_southboundb\x06proto3"

var (
	file_hostmgr_proto_hostmgr_southbound_proto_rawDescOnce sync.Once
	file_hostmgr_proto_hostmgr_southbound_proto_rawDescData []byte
)
...
func file_hostmgr_proto_hostmgr_southbound_proto_rawDescGZIP() []byte {
	file_hostmgr_proto_hostmgr_southbound_proto_rawDescOnce.Do(func() {
		file_hostmgr_proto_hostmgr_southbound_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_hostmgr_proto_hostmgr_southbound_proto_rawDesc), len(file_hostmgr_proto_hostmgr_southbound_proto_rawDesc)))
	})
...
var file_hostmgr_proto_hostmgr_southbound_proto_goTypes = []any{
...
func file_hostmgr_proto_hostmgr_southbound_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_hostmgr_proto_hostmgr_southbound_proto_rawDesc), len(file_hostmgr_proto_hostmgr_southbound_proto_rawDesc)),
			NumEnums:      6,
			NumMessages:   31,
			NumExtensions: 0,
			NumServices:   1,
