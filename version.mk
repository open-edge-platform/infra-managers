...
# No version reported
GNOSTICGRPCVERSION_REQ         := 0.1.1
GNOSTICVERSION_REQ             := 0.6.9
GOCOBERTURAVERSION_REQ         := 1.2.0
POSTGRES_VERSION               := 16.4
PROTOCGENGRPCGATEWAY_REQ       := 2.15.0
...
ifeq ($(GNOSTIC), true)
	$(GOCMD) install github.com/google/gnostic@v$(GNOSTICVERSION_REQ)
endif
ifeq ($(GNOSTICGRPC), true)
	$(GOCMD) install github.com/googleapis/gnostic-grpc@v$(GNOSTICGRPCVERSION_REQ)
endif
ifeq ($(PROTOCGENGRPCGATEWAY), true)
	$(GOCMD) install github.com/grpc-ecosystem/grpc-gateway/v2/protoc-gen-grpc-gateway@v$(PROTOCGENGRPCGATEWAY_REQ)
endif
